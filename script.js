...
function initTypingEffect() {
  ...
  if (h2Element && !h2Element.hasAttribute("data-typed")) {
    const fullText = "Data Analyst and Web Developer";
    h2Element.setAttribute("data-typed", "true");
    h2Element.textContent = "";
    let index = 0;

    const typeChar = () => {
      if (index < fullText.length) {
        h2Element.textContent = fullText.substring(0, index + 1);
        index++;
